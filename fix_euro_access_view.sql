-- Fix the active_euro_access_grants view to include budget fields
-- The original view was created with SELECT * before budget fields were added
-- This script recreates the view to include all fields
...
SELECT
    ...
    featured,
    priority,
    -- Budget fields that were added later
    funding_rate,
...
-- Verify the view includes budget fields
SELECT 
    id, 
    title, 
    funding_rate, 
